...
Die Integrationsdemo (**0.7.2**) liegt unter [`fusion_addin/FrameKit`](fusion_addin/FrameKit) vor. Sie bietet drei Dialogreiter, speicherbare Standardwerte und die Erstellung eines Gestells aus Demo-Vollprofilen oder eigenen DXF-Profilen mit optionalen Zwischenböden und anschließendem „Zoom auf alles“. Füße und Rollen sind als Zylinderplatzhalter auswählbar; eigene Varianten lassen sich speichern und löschen. Jeder Rahmen erhält eine Platte; die Deckplatte kann wahlweise ohne Aussparungen auf den Profilen montiert werden. Bodenanzahl, Einzelhöhen und Plattenstärke sind einstellbar; leere Höhen werden gleichmäßig verteilt. Zum Laden und Testen sowie zum aktuellen Prüfstand siehe [Demo-Anleitung](docu/demo_installation.md). Die folgenden Funktionen beschreiben den geplanten vollständigen Umfang.

Neu in **0.7.2 (S10)**: **FrameKit: CSV-Listen exportieren** bietet Zuschnittliste, Stückliste oder beide Listen. Die Stückliste ergänzt Platten mit Eckausklinkungen, Füße/Rollen und STEP-Winkel; Platzhalter und fehlende Befestigungen sind gekennzeichnet. Beim automatischen Fusion-Start wartet FrameKit jetzt mit den STEP-Importen bis zum Ende der Initialisierung. [Bedienung, Startkorrektur und Prüfstand](docu/stueckliste.md). 154 lokale Tests erfolgreich; Export und Fusion-Start vom Benutzer als funktionsfähig bestätigt.

Neu in **0.7.0 (S09)**: **FrameKit: Zuschnittliste exportieren** speichert Profilzuschnitte des ausgewählten Gestells als CSV. Gleiche Definitionen, Längen und Endbearbeitungen werden zusammengefasst; Herstellerdaten und Bauteil-IDs bleiben enthalten. Zwei CSV-Formate für deutsche und internationale Tabellenverarbeitung. Das Bearbeiten-Icon ergänzt das Grundsymbol um einen Stift. [Bedienung und Prüfstand](docu/zuschnittliste.md). 142 lokale Tests erfolgreich; Fusion-Abnahme des Exports offen.
...
Neu in **0.5.0 (S08)**: **FrameKit: Gestell bearbeiten** lädt eine vorhandene Hauptbaugruppe mit ihren gespeicherten Einstellungen. Vorschau, kontrollierter Neuaufbau und Erhaltung bestehender Bauteil-IDs sind umgesetzt. Manuelle Änderungen an generierten Teilen werden ersetzt; fremde Unterkomponenten blockieren den Neuaufbau. [Bedienung und Prüfschritte](docu/gestell_bearbeiten.md). 126 lokale Tests erfolgreich; Fusion-Prüfung einschließlich Rückgängig noch offen.
